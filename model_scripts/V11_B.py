"""
  uses V2 model and V10 callbacks as well as augmentation using a custom layer
"""
import datetime
...
from keras.layers import RandomFlip, RandomBrightness, RandomZoom, Layer, RandomTranslation
...
def create_augment_layers():
    augment_layers = tf.keras.Sequential(
        [
            ...
            RandomRGB(prob=0.025),
            RandomHue(factor=0.005),
            RandomTranslation(height_factor=0.1, width_factor=0.1),
            RandomBrightness(factor=0.025, value_range=(0, 1)),
        ],
        name="augment_layers",
    )
