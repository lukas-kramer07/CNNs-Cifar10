"""learning rate scheduler adapted from https://scorrea92.medium.com/cosine-learning-rate-decay-e8b50aa455b"""
...
class WarmUpCosineDecayScheduler(Callback):
    ...
    def on_batch_begin(self, batch, logs=None):
        ...
        if (
            self.stop_epoch is not None
            and self.stop_epoch > 0
